init:
    ...
    #
    # python:
    #     def fft_git_add_mod(tg, links, name, desc):
    #         global git_links
    #         global git_info
    ...
    #         'name': name,
    #         'desc': desc,
    #         'scr1': 'git_screens/{} (1).png'.format(tg),
    #         'scr2': 'git_screens/{} (2).png'.format(tg),
    #         'scr3': 'git_screens/{} (3).png'.format(tg)
    #         }
    #         git_mod_lists.append(tg)
    #         pass

    $ git_links['la'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/git_lena_alternate_base.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/git_lena_alternate.rpa")
    $ git_info['la'] = {
    'name':'Лена. Альтернативная концовка',
    'desc':'', ##-
    'scr1':'git_screens/la (1).png',
    'scr2':'git_screens/la (2).png',
    'scr3':'git_screens/la (3).png'
    }
    $ git_mod_lists.append('la')

    $ git_links['ls'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/git_lena_story_base.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/git_lena_story.rpa")
    $ git_info['ls'] = {
    'name':'История Лены',
    'desc':'', ##-
    ...
    $ git_mod_lists.append('ls')

    $ git_links['dwl'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/git_dayswithlena.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/git_dayswithlena_res.rpa")
    $ git_info['dwl'] = {
    'name': "Дни с Леной",
    ...
    $ git_mod_lists.append('bm')

    $ git_links['vkun'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/git_vkun_fog.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/VKUN_MOD.rpa")
    $ git_info['vkun'] = {
    'name': 'Совёнок в тумане',
    ...
    $ git_mod_lists.append('vkun')

    $ git_links['st'] = ("https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_sumtime/git_sumtime_base.rpyc", "https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_sumtime/git_sumtime.rpa")
    $ git_info['st'] = {
    'name': "Время лета",
    ...
    $ git_mod_lists.append('st')

    $ git_links['emk1'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/emk1_base.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/emk1.rpa")
    $ git_info['emk1'] = {
    'name': "Эпилог МК1",
    'desc': '', ##-
    ...
    $ git_mod_lists.append('emk1')

    $ git_links['v17'] = ("https://github.com/tsunderekun/es_gitmods/raw/master/base_v17.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/git_v17.rpa")
    $ git_info['v17'] = {
    'name': 'Где мои семнадцать лет?',
    'desc': '', ##-
    'scr1': 'git_screens/v17 (1).png',
    'scr2': 'git_screens/v17 (2).png',
    'scr3': 'git_screens/v17 (3).png'
    }
    $ git_mod_lists.append('v17')

    $ git_links['rs'] = ("https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_rs/rs_base.rpyc", "https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_rs/rs_common.rpa")
    $ git_info['rs'] = {
    'name': "Чёрная страница из дневника Сэм",
    ...
    $ git_mod_lists.append('rs')

    $ git_links['hs'] = ("https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_hs/hs_base.rpyc", "https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_hs/hs_common.rpa")
    $ git_info['hs'] = {
    'name': "Ужасное лето",
    ...
    $ git_mod_lists.append('hs')

    $ git_links['idnh'] = ("https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_idnh/idnh_base.rpyc", "https://gitlab.com/tsunderekun/esgml_mods/raw/master/git_idnh/idnh_common.rpa")
    $ git_info['idnh'] = {
    'name': 'Re: I Do Not Have',
    ...
    $ git_mod_lists.append('idnh')

    # $ fft_git_add_mod(
    # 'bm',
    # ("https://github.com/tsunderekun/es_gitmods/raw/master/git_vkun_fog.rpyc", "https://github.com/tsunderekun/es_gitmods/raw/master/VKUN_MOD.rpa"),
    # 'Большая ошибка',
    # ''
    #  )
